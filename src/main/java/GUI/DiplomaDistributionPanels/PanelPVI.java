...
public class PanelPVI extends DiplomaDistributionTab {    // проведення вступних іспитів

    public PanelPVI(MainFrame parent, boolean openSecondSemester, int JScrollBarValue, int verticalScrollBarMaximum) {
        super(parent);

        // **************************************   PanelPVI_logic (1 semester)  ***************************************
        cards.add(new JPanel() {
            ...
            JPanel execute() {
                ...
                String[] columnNamesUKR = {"№", "ПІБ", "Посада", "маг ОПП Б", "маг ОПП К", "маг ОНП Б", "маг ОНП К", "док ф Б", "док ф К"};
                DefaultTableModel model2 = new DefaultTableModel();
                String[] totalColumnNames = {"РАЗОМ:", "-", "-", "маг ОПП Б", "маг ОПП К", "маг ОНП Б", "маг ОНП К", "док ф Б", "док ф К"};
                ...
                for (Teacher_and_DiplomaStudentsData TandD : teacherAndData) {
                    Object[] o = new Object[] {TandD.getId_teacher(), TandD.getName(), TandD.getJob_title(),
                            TandD.getPvi_mopp_b(), TandD.getPvi_mopp_k(),
                            TandD.getPvi_monp_b(), TandD.getPvi_monp_k(), TandD.getPvi_df_b(), TandD.getPvi_df_k() };
                    model.addRow(o);
                }
                ...
                ColumnGroup g_pvi = new ColumnGroup("Проведення вступних іспитів");
                g_pvi.add(cm.getColumn(3));
                g_pvi.add(cm.getColumn(4));
                g_pvi.add(cm.getColumn(5));
                g_pvi.add(cm.getColumn(6));
                g_pvi.add(cm.getColumn(7));
                g_pvi.add(cm.getColumn(8));

                GroupableTableHeader header = (GroupableTableHeader)table1.getTableHeader();
                header.addColumnGroup(g_name);
                header.addColumnGroup(g_pvi);

                TableColumnModel cm1 = tableTotal.getColumnModel();
                g_name = new ColumnGroup("-");
                g_name.add(cm1.getColumn(1));
                g_name.add(cm1.getColumn(2));
                g_pvi = new ColumnGroup("Проведення вступних іспитів");
                g_pvi.add(cm1.getColumn(3));
                g_pvi.add(cm1.getColumn(4));
                g_pvi.add(cm1.getColumn(5));
                g_pvi.add(cm1.getColumn(6));
                g_pvi.add(cm1.getColumn(7));
                g_pvi.add(cm1.getColumn(8));
                ...
                tb.addTableModelListener(new TableModelListener() {       // Update Tables
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        Teacher.updateTeacher_oneField(teacherAndData.get(e.getFirstRow()).getId_teacher(), e.getColumn() + dataShift, tb.getValueAt(e.getFirstRow(),e.getColumn()).toString());     // (зсув + 38)

                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 5, new boolean[] {false, false, false, false, false, false, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());           // JTabbedPaneOpenIndex: 6   openSecondSemester: false
                    }
                });
                ...
                tm1.addTableModelListener(new TableModelListener() {
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        Teacher_and_DiplomaStudentsData.updatePlanned_oneField(e.getColumn() - 3 + dataShift, Integer.parseInt(tm1.getValueAt(e.getFirstRow(), e.getColumn()).toString()));     // updating 'ЗАПЛАНОВАНО' (planned)   (зсув + 38)
                ...
                courseGroups = CourseGroups.selectFromCourseGroupsByWorkType("Проведення вступних іспитів", "1");        // workType: PVI   semester: 1
                ...
                ColumnGroup g_kar1 = new ColumnGroup("Проведення вступних іспитів");               // !!!
                ...
                model3.addTableModelListener(new TableModelListener() {    // Update Table 'tableCourseGroups'
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 5, new boolean[] {false, false, false, false, false, false, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());        // JTabbedPaneOpenIndex: 6   2semester: false
                    }
                });
        ...
        cards.add(new JPanel() {
            ...
            JPanel execute() {
                ...
                for (Teacher_and_DiplomaStudentsData TandD : teacherAndData) {
                    Object[] o = new Object[] {TandD.getId_teacher(), TandD.getName(), TandD.getJob_title(),
                            TandD.getPvi_mopp_b_2(), TandD.getPvi_mopp_k_2(),
                            TandD.getPvi_monp_b_2(), TandD.getPvi_monp_k_2(), TandD.getPvi_df_b_2(), TandD.getPvi_df_k_2() };
                    model.addRow(o);
                }
                table1.setModel(model);
                ...
                tb.addTableModelListener(new TableModelListener() {       // Update Tables
                    ...
                    public void tableChanged(TableModelEvent e) {
                        System.out.println(e.getFirstRow() + " " + e.getColumn() + " -> " + tb.getValueAt(e.getFirstRow(),e.getColumn()));
                        Teacher.updateTeacher_oneField(teacherAndData.get(e.getFirstRow()).getId_teacher(), e.getColumn() + dataShift, tb.getValueAt(e.getFirstRow(),e.getColumn()).toString());     // (зсув + 60 + 38)

                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 5, new boolean[] {false, false, false, false, false, true, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());           // JTabbedPaneOpenIndex: 6   openSecondSemester: true
                    }
                });
                TableModel tm1 = tableTotal.getModel();
                tm1.addTableModelListener(new TableModelListener() {
                    ...
                    public void tableChanged(TableModelEvent e) {
                        System.out.println(e.getFirstRow() + " " + e.getColumn() + " -> " + tm1.getValueAt(e.getFirstRow(),e.getColumn()));
                        Teacher_and_DiplomaStudentsData.updatePlanned_oneField(e.getColumn() - 3 + dataShift, Integer.parseInt(tm1.getValueAt(e.getFirstRow(), e.getColumn()).toString()));     // updating 'ЗАПЛАНОВАНО' (planned)   (зсув + 60 + 38)

                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 5, new boolean[] {false, false, false, false, false, true, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());           // JTabbedPaneOpenIndex: 6   openSecondSemester: false
                    }
                });
                ...
                courseGroups = CourseGroups.selectFromCourseGroupsByWorkType("Проведення вступних іспитів", "2");        // workType: PVI   semester: 2
                ...
                model3.addTableModelListener(new TableModelListener() {    // Update Table 'tableCourseGroups'
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        if (e.getColumn() == 1) {
                            ...
                            CourseGroups.updateCourseGroups_oneField(courseGroups.get(e.getFirstRow()).getId(), "groups", model3.getValueAt(e.getFirstRow(), e.getColumn()).toString());
                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 5, new boolean[] {false, false, false, false, false, true, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());        // JTabbedPaneOpenIndex: 6   2semester: true
                    }
                });
