...
public class PanelKOAR extends DiplomaDistributionTab {    // Консультув. атестац. роб

    public PanelKOAR(MainFrame parent, boolean openSecondSemester, int JScrollBarValue, int verticalScrollBarMaximum) {
        super(parent);

        // **************************************   PanelKOAR_logic (1 semester)  ***************************************
        cards.add(new JPanel() {
            private Font font;
            private JTable table1 = new JTable() {public boolean isCellEditable(int row, int column) {
                return column > 2;
            }
            ...
            JPanel execute() {
                ...
                for (Teacher_and_DiplomaStudentsData TandD : teacherAndData) {
                    Object[] o = new Object[] {TandD.getId_teacher(), TandD.getName(), TandD.getJob_title(),
                            TandD.getKoar_b_b(), TandD.getKoar_b_k(), TandD.getKoar_mopp_b(), TandD.getKoar_mopp_k(),
                            TandD.getKoar_monp_b(), TandD.getKoar_monp_k() };
                    model.addRow(o);
                }
                ...
                ColumnGroup g_koar = new ColumnGroup("Консультув. атестац. роб");
                g_koar.add(cm.getColumn(3));
                g_koar.add(cm.getColumn(4));
                g_koar.add(cm.getColumn(5));
                g_koar.add(cm.getColumn(6));
                g_koar.add(cm.getColumn(7));
                g_koar.add(cm.getColumn(8));

                GroupableTableHeader header = (GroupableTableHeader)table1.getTableHeader();
                header.addColumnGroup(g_name);
                header.addColumnGroup(g_koar);

                TableColumnModel cm1 = tableTotal.getColumnModel();
                g_name = new ColumnGroup("-");
                g_name.add(cm1.getColumn(1));
                g_name.add(cm1.getColumn(2));
                g_koar = new ColumnGroup("Консультув. атестац. роб");
                g_koar.add(cm1.getColumn(3));
                g_koar.add(cm1.getColumn(4));
                g_koar.add(cm1.getColumn(5));
                g_koar.add(cm1.getColumn(6));
                g_koar.add(cm1.getColumn(7));
                g_koar.add(cm1.getColumn(8));
                ...
                tb.addTableModelListener(new TableModelListener() {       // Update Tables
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        Teacher.updateTeacher_oneField(teacherAndData.get(e.getFirstRow()).getId_teacher(), e.getColumn() + dataShift, tb.getValueAt(e.getFirstRow(),e.getColumn()).toString());    // (зсув + 20)

                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 2, new boolean[] {false, false, false, false, false, false, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());           // JTabbedPaneOpenIndex: 3   openSecondSemester: false
                    }
                });
                ...
                tm1.addTableModelListener(new TableModelListener() {
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        Teacher_and_DiplomaStudentsData.updatePlanned_oneField(e.getColumn() - 3 + dataShift, Integer.parseInt(tm1.getValueAt(e.getFirstRow(), e.getColumn()).toString()));     // updating 'ЗАПЛАНОВАНО' (planned)   (зсув + 20)
                ...
                courseGroups = CourseGroups.selectFromCourseGroupsByWorkType("Консультув. атестац. роб", "1");        // workType: KOAR   semester: 1
                ...
                ColumnGroup g_kar1 = new ColumnGroup("Консультув. атестац. роб");               // !!!
                ...
                model3.addTableModelListener(new TableModelListener() {    // Update Table 'tableCourseGroups'
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 2, new boolean[] {false, false, false, false, false, false, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());        // JTabbedPaneOpenIndex: 3   2semester: false
                    }
                });
        ...
        cards.add(new JPanel() {
            ...
            JPanel execute() {
                ...
                for (Teacher_and_DiplomaStudentsData TandD : teacherAndData) {
                    Object[] o = new Object[] {TandD.getId_teacher(), TandD.getName(), TandD.getJob_title(),
                            TandD.getKoar_b_b_2(), TandD.getKoar_b_k_2(), TandD.getKoar_mopp_b_2(), TandD.getKoar_mopp_k_2(),
                            TandD.getKoar_monp_b_2(), TandD.getKoar_monp_k_2() };
                    model.addRow(o);
                }
                table1.setModel(model);
                ...
                tb.addTableModelListener(new TableModelListener() {       // Update Tables
                    ...
                    public void tableChanged(TableModelEvent e) {
                        System.out.println(e.getFirstRow() + " " + e.getColumn() + " -> " + tb.getValueAt(e.getFirstRow(),e.getColumn()));
                        Teacher.updateTeacher_oneField(teacherAndData.get(e.getFirstRow()).getId_teacher(), e.getColumn() + dataShift, tb.getValueAt(e.getFirstRow(),e.getColumn()).toString());    // (зсув + 20 + 60)

                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 2, new boolean[] {false, false, true, false, false, false, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());           // JTabbedPaneOpenIndex: 3   openSecondSemester: true
                    }
                });
                TableModel tm1 = tableTotal.getModel();
                tm1.addTableModelListener(new TableModelListener() {
                    ...
                    public void tableChanged(TableModelEvent e) {
                        System.out.println(e.getFirstRow() + " " + e.getColumn() + " -> " + tm1.getValueAt(e.getFirstRow(),e.getColumn()));
                        Teacher_and_DiplomaStudentsData.updatePlanned_oneField(e.getColumn() - 3 + dataShift, Integer.parseInt(tm1.getValueAt(e.getFirstRow(), e.getColumn()).toString()));     // updating 'ЗАПЛАНОВАНО' (planned)   (зсув + 20 + 60)
                ...
                courseGroups = CourseGroups.selectFromCourseGroupsByWorkType("Консультув. атестац. роб", "2");        // workType: KOAR   semester: 2
                ...
                model3.addTableModelListener(new TableModelListener() {    // Update Table 'tableCourseGroups'
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        if (e.getColumn() == 1) {
                            ...
                            CourseGroups.updateCourseGroups_oneField(courseGroups.get(e.getFirstRow()).getId(), "groups", model3.getValueAt(e.getFirstRow(), e.getColumn()).toString());
                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 2, new boolean[] {false, false, true, false, false, false, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());        // JTabbedPaneOpenIndex: 3   2semester: true
                    }
                });
