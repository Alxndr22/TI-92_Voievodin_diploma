...
public class PanelKOVE extends DiplomaDistributionTab {    // Консультув по випускн. екзамену

    public PanelKOVE(MainFrame parent, boolean openSecondSemester, int JScrollBarValue, int verticalScrollBarMaximum) {
        super(parent);

        // **************************************   PanelKOVE_logic (1 semester)  ***************************************
            ...
            JPanel execute() {
                ...
                for (Teacher_and_DiplomaStudentsData TandD : teacherAndData) {
                    Object[] o = new Object[] {TandD.getId_teacher(), TandD.getName(), TandD.getJob_title(),
                            TandD.getKove_b_b(), TandD.getKove_b_k(), TandD.getKove_mopp_b(), TandD.getKove_mopp_k(),
                            TandD.getKove_monp_b(), TandD.getKove_monp_k() };
                    model.addRow(o);
                }
                ...
                ColumnGroup g_kove = new ColumnGroup("Консультув. по випускн. екз");
                g_kove.add(cm.getColumn(3));
                g_kove.add(cm.getColumn(4));
                g_kove.add(cm.getColumn(5));
                g_kove.add(cm.getColumn(6));
                g_kove.add(cm.getColumn(7));
                g_kove.add(cm.getColumn(8));

                GroupableTableHeader header = (GroupableTableHeader)table1.getTableHeader();
                header.addColumnGroup(g_name);
                header.addColumnGroup(g_kove);

                TableColumnModel cm1 = tableTotal.getColumnModel();
                g_name = new ColumnGroup("-");
                g_name.add(cm1.getColumn(1));
                g_name.add(cm1.getColumn(2));
                g_kove = new ColumnGroup("Консультув. по випускн. екз");
                g_kove.add(cm1.getColumn(3));
                g_kove.add(cm1.getColumn(4));
                g_kove.add(cm1.getColumn(5));
                g_kove.add(cm1.getColumn(6));
                g_kove.add(cm1.getColumn(7));
                g_kove.add(cm1.getColumn(8));
                ...
                tb.addTableModelListener(new TableModelListener() {       // Update Tables
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        Teacher.updateTeacher_oneField(teacherAndData.get(e.getFirstRow()).getId_teacher(), e.getColumn() + dataShift, tb.getValueAt(e.getFirstRow(),e.getColumn()).toString());      // (зсув + 26)

                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 3, new boolean[] {false, false, false, false, false, false, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());           // JTabbedPaneOpenIndex: 4    openSecondSemester: false
                    }
                });
                ...
                tm1.addTableModelListener(new TableModelListener() {
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        Teacher_and_DiplomaStudentsData.updatePlanned_oneField(e.getColumn() - 3 + dataShift, Integer.parseInt(tm1.getValueAt(e.getFirstRow(), e.getColumn()).toString()));     // updating 'ЗАПЛАНОВАНО' (planned)   (зсув + 26)
                ...
                courseGroups = CourseGroups.selectFromCourseGroupsByWorkType("Консультув. по випускн. екз", "1");        // workType: KOVE   semester: 1
                ...
                ColumnGroup g_kar1 = new ColumnGroup("Консультув. по випускн. екз");               // !!!
                ...
                model3.addTableModelListener(new TableModelListener() {    // Update Table 'tableCourseGroups'
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 3, new boolean[] {false, false, false, false, false, false, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());        // JTabbedPaneOpenIndex: 4   2semester: false
                    }
                });
        ...
        cards.add(new JPanel() {
            ...
            JPanel execute() {
                ...
                for (Teacher_and_DiplomaStudentsData TandD : teacherAndData) {
                    Object[] o = new Object[] {TandD.getId_teacher(), TandD.getName(), TandD.getJob_title(),
                            TandD.getKove_b_b_2(), TandD.getKove_b_k_2(), TandD.getKove_mopp_b_2(), TandD.getKove_mopp_k_2(),
                            TandD.getKove_monp_b_2(), TandD.getKove_monp_k_2() };
                    model.addRow(o);
                }
                table1.setModel(model);
                ...
                tb.addTableModelListener(new TableModelListener() {       // Update Tables
                    ...
                    public void tableChanged(TableModelEvent e) {
                        System.out.println(e.getFirstRow() + " " + e.getColumn() + " -> " + tb.getValueAt(e.getFirstRow(),e.getColumn()));
                        Teacher.updateTeacher_oneField(teacherAndData.get(e.getFirstRow()).getId_teacher(), e.getColumn() + dataShift, tb.getValueAt(e.getFirstRow(),e.getColumn()).toString());      // (зсув + 26 + 60)

                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 3, new boolean[] {false, false, false, true, false, false, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());           // JTabbedPaneOpenIndex: 4   openSecondSemester: true
                    }
                });
                TableModel tm1 = tableTotal.getModel();
                tm1.addTableModelListener(new TableModelListener() {
                    ...
                    public void tableChanged(TableModelEvent e) {
                        System.out.println(e.getFirstRow() + " " + e.getColumn() + " -> " + tm1.getValueAt(e.getFirstRow(),e.getColumn()));
                        Teacher_and_DiplomaStudentsData.updatePlanned_oneField(e.getColumn() - 3 + dataShift, Integer.parseInt(tm1.getValueAt(e.getFirstRow(), e.getColumn()).toString()));     // updating 'ЗАПЛАНОВАНО' (planned)  (зсув + 26 + 60)
                ...
                courseGroups = CourseGroups.selectFromCourseGroupsByWorkType("Консультув. по випускн. екз", "2");        // workType: KOVE   semester: 2
                ...
                model3.addTableModelListener(new TableModelListener() {    // Update Table 'tableCourseGroups'
                    ...
                    public void tableChanged(TableModelEvent e) {
                        ...
                        if (e.getColumn() == 1) {
                            ...
                            CourseGroups.updateCourseGroups_oneField(courseGroups.get(e.getFirstRow()).getId(), "groups", model3.getValueAt(e.getFirstRow(), e.getColumn()).toString());
                        System.out.println("••• UPDATING THIS PANEL •••");
                        parent.updateThisPanel(1, 3, new boolean[] {false, false, false, true, false, false, false, false}, iptt.getJScrollPane_table1().getVerticalScrollBar().getValue(), iptt.getJScrollPane_table1().getVerticalScrollBar().getMaximum());        // JTabbedPaneOpenIndex: 4   2semester: true
                    }
                });
